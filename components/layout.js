      ...
      <main className={styles.mainContent}>
        ...
        <section className={styles.personalInfo}>
          ...
          <p>
            ...
            <strong>Name:</strong> Ms. Kunpriyaa Chaiyawong<br />
            <strong>Education:</strong> Currently studying at <i>University of Phayao</i>, Faculty of ICT, Software Engineering, 2nd Year
          </p>
        </section>
